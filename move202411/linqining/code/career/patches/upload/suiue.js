...
import { shallowRef, triggerRef, inject, provide, computed, ref, reactive, watch, readonly, defineComponent, onMounted, renderSlot, createTextVNode, Fragment, Comment, isVNode, vShow, getCurrentInstance, onBeforeMount, onBeforeUnmount, toRef, h, Teleport, onActivated, onDeactivated, watchEffect, Transition, TransitionGroup, mergeProps, nextTick, cloneVNode, withDirectives, openBlock, createElementBlock, createVNode, unref, withCtx, toDisplayString, renderList, createBlock, createElementVNode } from "vue";
...
const browserWallets = shallowRef([]);
...
class WalletState {
  constructor(config) {
    ...
    this._config = config;
    this._wallet = shallowRef();
    this.wallet = computed(() => this._wallet.value);
    this._accounts = shallowRef([]);
    this._onConnects = [];
...
class WalletQuery {
  constructor(config, state) {
    ...
    watch(this._state.isConnected, (value2) => {
      if (value2) {
  ...
  get domain() {
    if (this._domain.value === void 0) {
      const cancel = watch(this._state.isConnected, (value2) => {
        if (value2) {
...
function useFalseUntilTruthy(originalRef) {
  ...
  const stop = watch(originalRef, (value2) => {
    if (value2) {
...
function useLockHtmlScroll(lockRef) {
  ...
  onMounted(() => {
    watchStopHandle = watch(lockRef, (value2) => {
      if (value2) {
        if (!lockCount) {
...
const NFadeInExpandTransition = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      const type2 = group ? TransitionGroup : Transition;
      const resolvedProps = {
      ...
      return h(type2, resolvedProps, slots);
    };
  }
});
...
const NBaseClose = defineComponent({
  ...
  setup(props) {
    useStyle("-base-close", style$9, toRef(props, "clsPrefix"));
    return () => {
      const {
        clsPrefix,
        disabled,
  ...
  render() {
    ...
    return h(Component, {
      ...
      return children || this.title || this.closable ? h("div", {
        ...
        role: "heading"
      }, children || this.title), resolveWrappedSlot($slots["header-extra"], (children2) => children2 && h("div", {
        class: [`${mergedClsPrefix}-card-header__extra`, this.headerExtraClass],
        style: this.headerExtraStyle
      }, children2)), this.closable ? h(NBaseClose, {
        clsPrefix: mergedClsPrefix,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(unref(NButton), mergeProps(_ctx.$attrs, {
          onMouseenter: _cache[0] || (_cache[0] = ($event) => mouseIn.value = true),
          onMouseleave: _cache[1] || (_cache[1] = ($event) => mouseIn.value = false),
          onClick: _cache[2] || (_cache[2] = ($event) => unref(isConnected) ? unref(disconnect)() : toggleModal()),
          style: { "width": "128px" }
        }), {
          default: withCtx(() => [
            !mouseIn.value ? (openBlock(), createElementBlock("span", _hoisted_1, toDisplayString(unref(isConnected) ? unref(domain) ? unref(domain) : unref(address) : "connect"), 1)) : (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(unref(isConnected) ? "disconnect" : "connect"), 1))
          ]),
          _: 1
        }, 16),
        createVNode(unref(NModal), {
          ...
          "header-extra": withCtx(() => [
            createVNode(unref(NA), {
              ...
              default: withCtx(() => [
                createTextVNode("Suiue by suifans")
              ]),
              _: 1
            })
          ]),
          default: withCtx(() => [
            createVNode(unref(NGrid), {
              ...
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(wallets2), (wallet) => {
                  return openBlock(), createBlock(unref(NGridItem), {
                    key: JSON.stringify(wallet.chains)
                  }, {
                    default: withCtx(() => [
                      createVNode(unref(NButton), {
                        onClick: ($event) => unref(connect)(wallet).then(toggleModal),
                        style: { "height": "114px", "width": "100%" }
                      }, {
                        default: withCtx(() => [
                          createVNode(unref(NFlex), {
...
export {
  ...
  _sfc_main as NConnectButton,
  PluginNotInstallError,
  ProviderAlreadyExistsError,
  ProviderNotExistsError,
  RequestError,
  _sfc_main$1 as SuiueProvider,
